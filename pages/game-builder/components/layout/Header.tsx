  ...
  return (
    <div className="h-[115px] w-full bg-white flex px-10 items-center justify-between ">
     ...
     <div className="flex items-center gap-2">
        <img className={`${currentLevelIndex!==levels.length-1 && 'cursor-pointer'}`} src={`${currentLevelIndex==levels.length-1?"images/arrowDownBorderRoundDisable.svg":"images/arrowDownBorderRound.svg"}`}   alt="arrowdown" onClick={()=>{currentLevelIndex!==levels.length-1 && setCurrentLevel(currentLevelIndex+1)}} />
        <img className={`${currentLevelIndex!==0 && 'cursor-pointer' }`} src={`${currentLevelIndex==0?"images/arrowUpBorderRound.svg":"images/arrowUpBorderRoundEnable.svg"}`} alt="arrowup" onClick={()=>{currentLevelIndex!==0 && setCurrentLevel(currentLevelIndex-1)}} />
