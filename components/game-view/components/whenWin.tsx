  ...
  return (
    <div className='w-[400px]  flex flex-col gap-[75px] justify-center items-center'>
      {/* <Lottie 
        ...
        width={200}
      /> */}
        <p className='text-[30px] fontbold bg-white rounded-[11px] bg-opacity-10 backdrop-blur-sm   text-[#0CD92D] px-[75px] py-[25px]'>بردی این مرحله رو</p>
      
        {selectedLevelIndex == levels.length - 1 ? <div className='text-[25px] '>پایان بازی</div> :
          <div
